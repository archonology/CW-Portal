...
const AddResourceToTopic = () => {
    ...
    const [newResource, { error, resourceData }] = useMutation(CREATE_RESOURCE);
    ...
    const handleFormSubmit = async (event) => {
        ...
        try {
            const { resourceData } = await newResource({
                variables: { ...formState }
            });
        ...
        <>
            <Container sx={{ marginTop: "10em" }}>
                ...
                >
                    ...
                    >
                        <option className="variant-white">Add to which Topic:</option>
                        {allTopics.map((topic) => {
                            return (
                                <>
...
export default AddResourceToTopic;